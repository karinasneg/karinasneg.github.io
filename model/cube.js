...
function loadSkyBox() {
		...
		var materials = [
			createMaterial( 'https://karinasneg.github.io/pictures/Daylight_Box_Right.bmp' ), // right
...
var planeMaterial = new THREE.MeshPhongMaterial({  color: 0xD3E1F0, shading: THREE.FlatShading, transparent: true, map: bmap });
